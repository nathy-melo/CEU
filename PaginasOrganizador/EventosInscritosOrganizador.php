    ...
    <script>
        ...
        function renderizarFavoritos() {
            ...
            favoritosDados.forEach(ev => {
                ...
                a.href = `ContainerOrganizador.php?pagina=eventoInscrito&id=${ev.cod_evento}`;
            ...
            // Listeners já estão configurados globalmente no document
                ...
                const atualizarTodosBotoes = () => {
                    ...
                    todosBotoes.forEach(btn => {
                        ...
                        if (btnCod === cod) {
                            ...
                            // Se o clique foi fora do modal, atualizar botões DENTRO do modal
                            if (modalFavoritos && modalFavoritos.contains(btnFav)) {
                                // Clique foi no modal, atualizar botões FORA do modal
                                if (!estaNoModal) {
                                    atualizarIconeFavorito(btn, novoEstado);
                                    atualizados++;
                                }
                            } else {
                                // Clique foi fora do modal, atualizar botões DENTRO do modal
                                if (estaNoModal) {
                                    atualizarIconeFavorito(btn, novoEstado);
                                    atualizados++;
                                }
        ...
        // Função removida - não é mais necessária pois usamos apenas o listener global no document
