...
<script>
    ...
    function renderizarCertificados() {
        ...
        container.innerHTML = certificadosPagina.map(cert => {
            ...
            const horaEmissao = cert.criado_em ? new Date(cert.criado_em).toLocaleTimeString('pt-BR', {
                hour: '2-digit',
                minute: '2-digit'
            }) : '';
    ...
    function visualizarCertificado(codigo) {
        ...
        window.location.href = 'ContainerParticipante.php?pagina=visualizarCertificado&codigo=' + encodeURIComponent(codigo);
    }
