...
<style>
  ...
  .Local { grid-column: span 4 / span 4; grid-row-start: 2; }
  .CargaHoraria { grid-column: span 4 / span 4; grid-column-start: 5; grid-row-start: 2; }
  ...
  .BotaoDesinscrever { grid-column: span 2 / span 2; grid-column-start: 7; grid-row-start: 9; }
