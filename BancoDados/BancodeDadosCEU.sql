...
(2, 'Palestra', 'Palestra sobre IA', 'Auditório Principal', 'Discussão sobre o futuro da Inteligência Artificial.', 'Estudantes', '2025-11-20 14:00:00', '2025-11-20 16:00:00', 2.0, 1, 'Pesquisa', 'Híbrido', '/ImagensEventos/Palestra_sobre_IA.png', '2025-10-20 08:00:00', '2025-11-19 23:59:59'),
(3, 'Curso', 'Curso de Python', 'Laboratório 2', 'Curso completo de programação em Python.', 'Iniciantes', '2025-11-25 08:00:00', '2025-12-02 18:00:00', 40.0, 1, 'Extensão', 'Presencial', '/ImagensEventos/Python.png', '2025-10-25 08:00:00', '2025-11-24 23:59:59'),
(4, 'Semana', 'Semana da Tecnologia', 'Centro de Eventos', 'Uma semana repleta de atividades tecnológicas.', 'Todos', '2025-12-05 08:00:00', '2025-12-09 18:00:00', 50.0, 1, 'Ensino', 'Híbrido', '/ImagensEventos/Semana_de_CienciaTecnologia.png', '2025-11-05 08:00:00', '2025-12-04 23:59:59'),
(5, 'Minicurso', 'Minicurso de Git', 'Sala 202', 'Aprenda versionamento de código com Git.', 'Programadores', '2025-12-10 13:00:00', '2025-12-10 17:00:00', 4.0, 0, 'Sem certificacao', 'Online', '/ImagensEventos/Git_e_Github.png', '2025-11-10 08:00:00', '2025-12-09 23:59:59'),
(6, 'Workshop', 'Workshop de Design UX', 'Estudio Criativo', 'Fundamentos de experiência do usuário.', 'Designers', '2025-12-15 09:00:00', '2025-12-15 18:00:00', 9.0, 1, 'Pesquisa', 'Presencial', '/ImagensEventos/DesignUX.png', '2025-11-15 08:00:00', '2025-12-14 23:59:59'),
(7, 'Hackathon', 'Hackathon CEU 2025', 'Pavilhão Principal', 'Competição de desenvolvimento de 48 horas.', 'Desenvolvedores', '2025-12-20 18:00:00', '2025-12-22 18:00:00', 48.0, 1, 'Extensão', 'Presencial', '/ImagensEventos/Hackathon_CEU.png', '2025-11-20 08:00:00', '2025-12-19 23:59:59'),
(8, 'Palestra', 'Futuro do Trabalho', 'Anfiteatro', 'Como a tecnologia está mudando o mercado de trabalho.', 'Profissionais', '2026-01-10 19:00:00', '2026-01-10 21:00:00', 2.0, 0, 'Sem certificacao', 'Híbrido', '/ImagensEventos/Futuro_do_Trabalho.png', '2025-12-10 08:00:00', '2026-01-09 23:59:59'),
(9, 'Curso', 'Curso de React', 'Lab de Informática', 'Desenvolvimento de interfaces modernas com React.', 'Desenvolvedores', '2026-01-15 08:00:00', '2026-01-29 17:00:00', 60.0, 1, 'Ensino', 'Online', '/ImagensEventos/React.png', '2025-12-15 08:00:00', '2026-01-14 23:59:59'),
(10, 'Workshop', 'Workshop de Fotografia', 'Estúdio Fotográfico', 'Técnicas básicas e avançadas de fotografia.', 'Todos', '2026-02-05 10:00:00', '2026-02-05 16:00:00', 6.0, 0, 'Sem certificacao', 'Presencial', '/ImagensEventos/Workshop_de_Fotografia.png', '2026-01-05 08:00:00', '2026-02-04 23:59:59'),
(11, 'Minicurso', 'Introdução ao Machine Learning', 'Sala 303', 'Conceitos básicos de aprendizado de máquina.', 'Estudantes', '2026-02-10 14:00:00', '2026-02-10 18:00:00', 4.0, 1, 'Pesquisa', 'Híbrido', '/ImagensEventos/Machine_Learning.png', '2026-01-10 08:00:00', '2026-02-09 23:59:59'),
(12, 'Palestra', 'Sustentabilidade na Tech', 'Sala Verde', 'Como tornar a tecnologia mais sustentável.', 'Todos', '2026-02-15 16:00:00', '2026-02-15 18:00:00', 2.0, 0, 'Sem certificacao', 'Online', '/ImagensEventos/Sustentabilidade_na_Tech.png', '2026-01-15 08:00:00', '2026-02-14 23:59:59'),
(13, 'Curso', 'Desenvolvimento Mobile', 'Lab Mobile', 'Criação de aplicativos para Android e iOS.', 'Desenvolvedores', '2026-02-20 09:00:00', '2026-03-06 17:00:00', 16.0, 1, 'Extensão', 'Presencial', '/ImagensEventos/Desenvolvimento_mobile.png', '2026-01-20 08:00:00', '2026-02-19 23:59:59'),
(14, 'Workshop', 'Workshop de Blockchain', 'Auditório Tech', 'Entenda a tecnologia por trás das criptomoedas.', 'Todos', '2026-03-10 13:00:00', '2026-03-10 17:00:00', 4.0, 1, 'Outro', 'Híbrido', '/ImagensEventos/Blockchain.png', '2026-02-10 08:00:00', '2026-03-09 23:59:59'),
(15, 'Semana', 'Semana da Inovação', 'Campus Principal', 'Evento de inovação e empreendedorismo.', 'Empreendedores', '2026-03-15 08:00:00', '2026-03-19 18:00:00', 50.0, 1, 'Ensino', 'Presencial', '/ImagensEventos/Semana_de_Inovacao.png', '2026-02-15 08:00:00', '2026-03-14 23:59:59'),
(16, 'Minicurso', 'Cybersecurity Basics', 'Sala de Segurança', 'Fundamentos de segurança da informação.', 'Todos', '2026-03-25 14:00:00', '2026-03-25 18:00:00', 4.0, 1, 'Pesquisa', 'Online', '/ImagensEventos/CyberSecurity.png', '2026-02-25 08:00:00', '2026-03-24 23:59:59'),
(17, 'Conferência', 'Conferência de Cloud Computing', 'Auditório 3', 'Conferência sobre tendências em computação em nuvem.', 'Estudantes', '2026-04-01 13:00:00', '2026-04-01 18:00:00', 5.0, 1, 'Outro', 'Híbrido', '/ImagensEventos/Cloud_Computing.png', '2026-03-01 08:00:00', '2026-03-31 23:59:59');
